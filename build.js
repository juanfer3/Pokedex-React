...
var PokeApp = (function (_React$Component) {
  ...
  _createClass(PokeApp, [{
    ...
    value: function render() {
      var pokemons = [{ number: 1, name: 'Bulbasaur' }, { number: 7, name: 'Squirtle' }, { number: 4, name: 'Charmander' }];
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        this.props.pokemons.map(function (pokemon) {
          return _react2['default'].createElement(_PokeRow2['default'], { key: pokemon.number,
            name: pokemon.name,
            number: pokemon.number,
            growl: _this.props.onGrowl

          });
          console.log(_this.growl);
        })
      );
    }
  }]);
